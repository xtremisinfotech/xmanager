...
/**
 * Returns active keyword if the needle found in haystack.
 * @param Integer search value
 * @return String active keyword
 * @author Mahiman Parmar
 */
function getActiveClass($needle, $haystack)
{
    return in_array($needle, $haystack) ? ' active' : '';
}